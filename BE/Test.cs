   ...
   public class Test :ICloneable
    {
        ...
        public Test(string testerId, string traineeId,GearBox gear,CarType car, DateTime date, Address address, bool? test1_ReverseParking, bool? test2_KeepingSafeDistance, bool? test3_UsingMirrors, bool? test4_UsingTurnSignals, bool? test5_LegalSpeed, bool? succeeded, string notes)
        {
            id = null;
            this.testerId = testerId;
            this.traineeId = traineeId;
